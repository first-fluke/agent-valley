...
> Common entry point for all agents (Claude Code, Codex, Antigravity, Cursor, Grok, Kimi).
...
| 6 | **Agent Runner** | `AgentRunnerPort` abstraction (claude/codex/antigravity/cursor/grok/kimi via native protocols) + live intervention `RunHandle` |
