...
const routingRuleSchema = z.object({
  ...
  agent_type: z.enum(["claude", "codex", "antigravity", "cursor", "grok", "kimi"]).optional(),
...
const scoreRoutingTierSchema = z
  .object({
    ...
    agent: z.enum(["claude", "codex", "antigravity", "cursor", "grok", "kimi"]),
  })
...
export const globalConfigSchema = z
  .object({
    ...
    agent: z
      .object({
        type: z.enum(["claude", "codex", "antigravity", "cursor", "grok", "kimi"]).optional(),
...
const mergedConfigSchema = z
  .object({
    ...
    agentType: z.enum(["claude", "codex", "antigravity", "cursor", "grok", "kimi"]),
    ...
    routingRules: z.array(
      z.object({
        ...
        agentType: z.enum(["claude", "codex", "antigravity", "cursor", "grok", "kimi"]).optional(),
